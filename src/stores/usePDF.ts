...
export const usePDFStore = create<PDFState>((set) => ({
  ...
  setRequerimientoPerforadora: (requerimiento: number) =>
    set({ requerimientoPerforadora: requerimiento }),
  setRequerimientoScoopsLimpieza: (requerimiento: number) =>
    set({ requerimientoScoopsLimpieza: requerimiento }),
  setRequerimientoScoopsCarguio: (requerimiento: number) =>
    set({ requerimientoScoopsCarguio: requerimiento }),
  setRequerimientoScoopRelleno: (requerimiento: number) =>
    set({ requerimientoScoopRelleno: requerimiento }),
