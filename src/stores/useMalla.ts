...
export const useCarguioStore = create<CarguioState>()((set) => ({
  ...
  setDisponibilidadMecanica: (disponibilidad: number) =>
    set({ disponibilidadMecanica: disponibilidad }),
  setDisponibilidadOperativa: (disponibilidad: number) =>
    set({ disponibilidadOperativa: disponibilidad }),
...
export const useTransporteStore = create<TransporteState>()((set) => ({
  ...
  setDisponibilidadOperativaCamion: (disponibilidad: number) =>
    set({ disponibilidadOperativaCamion: disponibilidad }),
  setDisponibilidadMecanicaCamion: (disponibilidad: number) =>
...
export const useRellenoCementadoStore = create<RellenoCementadoState>()((set) => ({
  ...
  setCostoPreparacionPlantaConcreto: (valor: number) =>
    set({ costoPreparacionPlantaConcreto: valor }),
