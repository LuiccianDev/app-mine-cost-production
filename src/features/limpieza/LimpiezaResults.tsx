  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-x-4">
        ...
        <div className="flex items-center justify-between py-2">
          <span className="text-sm text-gray-600">Requerimiento de Scoops</span>
          <span className="text-sm font-medium text-gray-900">
            {isValid(resultados.requerimientoScoops)
              ? resultados.requerimientoScoops.toFixed(2)
              : '-'}
          </span>
        </div>
        <div className="flex items-center justify-between py-2">
          <span className="text-sm text-gray-600">Costo de Limpieza (US$/Ton)</span>
          <span className="text-sm font-medium text-gray-900">
            {isValid(resultados.costoLimpieza) ? resultados.costoLimpieza.toFixed(2) : '-'}
          </span>
        </div>
      </div>
    </div>
