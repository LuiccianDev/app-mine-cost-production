...
const defaultValues: LimpiezaFormValues = {
...
export default function LimpiezaForm({ onChange }: { onChange?: (values: LimpiezaFormValues) => void }) {
  const [values, setValues] = useState<LimpiezaFormValues>(defaultValues);
