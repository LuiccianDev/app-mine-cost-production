...
export default function RellenoDetriticoInputs({ inputValues, onChange, showResults, onToggleResults, resultsComponent, isAutoFilled = false }: RellenoDetriticoInputsProps) {
  return (
