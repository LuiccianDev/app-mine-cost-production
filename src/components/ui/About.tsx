  ...
  return (
    <section className="bg-white min-h-screen flex items-center py-10">
      <div className="container mx-auto px-8 w-full">
        ...
        <div className="mb-8">
          <p className="text-5xl font-light leading-tight max-w-3xl">
        ...
        <div className="flex justify-center items-center gap-12 pl-80">
          <div className="relative w-full max-w-sm">
            <div className="aspect-[4/4] bg-gray-200 rounded-lg overflow-hidden">
              <Image
                src="/img/logo.webp"
                alt="About"
                width={350}
